...
jest.mock('@/components/pages/buildings/building-view', () => ({
	__esModule: true,
...
describe('BuildingViewPage server component', () => {
	...
	it('renders building view for numeric id', async () => {
		mockAuth.mockResolvedValueOnce({ user: { pk: 2, email: 'user@example.com' } });
