...
jest.mock('@/components/pages/reservations/occupancy-view', () => ({
	__esModule: true,
	default: (props: { session?: Session }) => {
		// eslint-disable-next-line @typescript-eslint/no-require-imports
		const React = require('react');
		return React.createElement('div', null, `OCCUPANCY_CLIENT_MARKER:${JSON.stringify(props?.session ?? null)}`);
	},
}));
...
describe('OccupancyPage server component', () => {
	...
	it('renders OccupancyClient with session when session exists', async () => {
