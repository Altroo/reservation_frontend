...
jest.mock('@/components/pages/reservations/balance-view', () => ({
	__esModule: true,
...
describe('BalancePage server component', () => {
	...
	it('renders BalanceClient with session when session exists', async () => {
