									...
									<Card elevation={2} sx={{ borderRadius: 2 }}>
										<CardContent sx={{ p: 3 }}>
											...
											<Stack spacing={0}>
												...
												<Divider />
												<InfoRow icon={<SquareFootIcon />} label={t.locaux.surface} value={local.superficie ? `${local.superficie} m²` : null} />
											</Stack>
										</CardContent>
									</Card>
									...
									<Card elevation={2} sx={{ borderRadius: 2 }}>
										<CardContent sx={{ p: 3 }}>
											<Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 2 }}>
												...
												<Typography variant="h6" fontWeight={700}>{t.locaux.financial}</Typography>
											</Stack>
											<Divider sx={{ mb: { xs: 1.5, md: 2 } }} />
											<Stack spacing={0}>
												<InfoRow
									...
									<Card elevation={2} sx={{ borderRadius: 2 }}>
										<CardContent sx={{ p: 3 }}>
											<Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 2 }}>
												...
												<Typography variant="h6" fontWeight={700}>{t.locaux.rental}</Typography>
											</Stack>
											<Divider sx={{ mb: { xs: 1.5, md: 2 } }} />
											<Stack spacing={0}>
												<InfoRow
													...
													value={<Chip label={local.en_location ? t.locaux.inRental : t.common.free} size="small" color={local.en_location ? 'success' : 'default'} variant="outlined" />}
												/>
												{local.en_location && (
													<>
														<Divider />
														...
														<Divider />
														<InfoRow icon={<CalendarTodayIcon />} label={t.locaux.rentalStartDate} value={formatDate(local.date_debut_location ?? null)} />
													</>
												)}
											</Stack>
										</CardContent>
										...
										<Card elevation={2} sx={{ borderRadius: 2 }}>
											<CardContent sx={{ p: 3 }}>
												<Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 2 }}>
													...
													<Typography variant="h6" fontWeight={700}>{t.common.notes}</Typography>
												</Stack>
												<Divider sx={{ mb: { xs: 1.5, md: 2 } }} />
									...
									<Card elevation={2} sx={{ borderRadius: 2 }}>
										<CardContent sx={{ p: 3 }}>
											<Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 2 }}>
												...
												<Typography variant="h6" fontWeight={700}>{t.common.metadata}</Typography>
											</Stack>
											<Divider sx={{ mb: { xs: 1.5, md: 2 } }} />
											<Stack spacing={0}>
												<InfoRow icon={<PersonIcon />} label={t.common.createdBy} value={local.created_by_user_name ?? '—'} />
												<Divider />
												<InfoRow icon={<CalendarTodayIcon />} label={t.common.creationDate} value={formatDate(local.date_created)} />
												<Divider />
												<InfoRow icon={<CalendarTodayIcon />} label={t.common.lastUpdate} value={formatDate(local.date_updated)} />
											</Stack>
										</CardContent>
									</Card>
