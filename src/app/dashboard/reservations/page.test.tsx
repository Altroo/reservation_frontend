...
jest.mock('@/components/pages/reservations/reservations-list', () => ({
	__esModule: true,
	default: (props: { session?: Session }) => {
		// eslint-disable-next-line @typescript-eslint/no-require-imports
		const React = require('react');
		return React.createElement('div', null, `RESERVATIONS_LIST_CLIENT_MARKER:${JSON.stringify(props?.session ?? null)}`);
	},
}));
...
describe('ReservationsListPage server component', () => {
	...
	it('renders ReservationsListClient with session when session exists', async () => {
