...
describe('CostAddPage server component', () => {
	...
	it('renders CostFormClient with session and no id when session exists', async () => {
		const sessionValue: Session = { user: { pk: 7, email: 'manager@site.com' } };
