...
jest.mock('@/components/pages/costs/cost-form', () => ({
	__esModule: true,
...
describe('CostEditPage server component', () => {
	...
	it('redirects to COSTS_LIST when id is not a valid number', async () => {
	...
	it('renders CostFormClient with session and numeric id when valid', async () => {
