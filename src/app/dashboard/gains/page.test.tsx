...
jest.mock('@/components/pages/reservations/gains-view', () => ({
	__esModule: true,
	default: (props: { session?: Session }) => {
		// eslint-disable-next-line @typescript-eslint/no-require-imports
		const React = require('react');
		return React.createElement('div', null, `GAINS_CLIENT_MARKER:${JSON.stringify(props?.session ?? null)}`);
	},
}));
...
describe('GainsPage server component', () => {
	...
	it('renders GainsClient with session when session exists', async () => {
