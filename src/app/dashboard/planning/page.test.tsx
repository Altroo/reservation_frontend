...
jest.mock('@/components/pages/reservations/planning-month', () => ({
	__esModule: true,
	default: (props: { session?: Session }) => {
		// eslint-disable-next-line @typescript-eslint/no-require-imports
		const React = require('react');
		return React.createElement('div', null, `PLANNING_CLIENT_MARKER:${JSON.stringify(props?.session ?? null)}`);
	},
}));
...
describe('PlanningPage server component', () => {
	...
	it('renders PlanningMonthClient with session when session exists', async () => {
