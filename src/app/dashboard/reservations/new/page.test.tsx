...
jest.mock('@/components/pages/reservations/reservation-form', () => ({
	...
	default: (props: { session?: Session }) => {
		...
		return React.createElement('div', null, `RESERVATION_FORM_CLIENT_MARKER:${JSON.stringify(props?.session ?? null)}`);
	},
}));
...
describe('ReservationAddPage server component', () => {
	...
	it('renders ReservationFormClient with session when session exists', async () => {
